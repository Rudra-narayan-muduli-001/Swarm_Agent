...
class TestWebSearchExtended:
    def test_web_search_clamps_to_10(self):
        ...
        with patch("app.tools.web_search.os.getenv", return_value=None), \
             patch("app.tools.web_search._duckduckgo", return_value=[{"title":"t","url":"u","snippet":"s"}]) as mock:
    ...
    def test_web_search_tavily_vs_duckduckgo_selection(self):
        ...
        with patch("app.tools.web_search.os.getenv") as mock_env, \
             patch("app.tools.web_search._tavily", return_value=[{"title":"t","url":"u","snippet":"s"}]) as mock_t, \
             patch("app.tools.web_search._duckduckgo") as mock_d:
    ...
    def test_web_search_exception_contains_type(self):
        from app.tools.web_search import web_search
        with patch("app.tools.web_search.os.getenv", return_value=None), \
             patch("app.tools.web_search._duckduckgo", side_effect=RuntimeError("net down")):
            result = web_search("q")
    ...
    def test_web_search_none_results_error(self):
        from app.tools.web_search import web_search
        with patch("app.tools.web_search.os.getenv", return_value=None), \
             patch("app.tools.web_search._duckduckgo", return_value=None):
            result = web_search("q")
    ...
    def test_web_search_result_valid_json(self):
        ...
        with patch("app.tools.web_search.os.getenv", return_value=None), \
             patch("app.tools.web_search._duckduckgo", return_value=results):
    ...
    def test_tavily_api_payload(self):
        ...
        with patch("app.tools.web_search.httpx.post", return_value=mock_resp) as mock_post, \
             patch("app.tools.web_search.os.getenv", return_value="test_key_123"):
